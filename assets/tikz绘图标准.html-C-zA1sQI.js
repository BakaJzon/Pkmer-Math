import{_ as l,c as p,b as e,d as i,a as n,e as t,r as d,o as r}from"./app-D-WjZXta.js";const h={};function o(c,s){const a=d("Tikz");return r(),p("div",null,[s[0]||(s[0]=e(`<h1 id="简介" tabindex="-1">简介</h1><h2 id="环境配置" tabindex="-1">环境配置</h2><p>代码类型: tikz</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>\\usepackage{tikz}</span></span>
...
\\end{tikzpicture}
\\end{document}
`}),s[1]||(s[1]=e(`<h3 id="代码优化点" tabindex="-1">代码优化点：</h3><ol><li><strong>斜线填充</strong>： <ul><li>不能使用 <code>\\foreach</code> 在 <code>\\clip</code> 内部，因此 <strong>使用 <code>\\clip</code> 限制区域，然后绘制一系列平行线</strong>，保证它们只出现在圆内部。</li><li>这里的 <code>\\foreach \\y in {-1.5,-1.2,...,1.5}</code> 产生 <strong>从左到右的斜线</strong>。</li></ul></li><li><strong>旋转箭头</strong>： <ul><li>直接用 <code>arc[start angle=0,end angle=45]</code> 绘制 <strong>顺时针旋转的小箭头</strong>。</li></ul></li></ol><hr><h2 id="颜色填充" tabindex="-1">颜色填充</h2><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>% 填充阴影区域</span></span>
...
\\end{tikzpicture}
\\end{document}
`}),s[2]||(s[2]=e(`<div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>% 内层</span></span>
...
\\end{tikzpicture}
\\end{document}
`}),s[3]||(s[3]=n("h2",{id:"_3d",tabindex:"-1"},"3D",-1)),s[4]||(s[4]=n("p",null,[n("strong",null,[t("必须需要导入 "),n("code",null,"\\usepackage{tikz-3dplot}"),t(" 包!")])],-1)),i(a,{data:`\\usepackage{tikz-3dplot}
\\begin{document}
\\begin{tikzpicture}
...
\\end{tikzpicture}
\\end{document}
`}),s[5]||(s[5]=n("p",null,"真实边缘轮廓的角度为 \\tdplotsetmaincoords{80}{120} 后者120和其补角: 120+180, 这两个线是真实视角边缘轮廓线",-1)),i(a,{data:`\\usepackage{tikz-3dplot}
\\begin{document}
\\begin{tikzpicture}
   % 设置 3D 视角
...
\\end{tikzpicture}
\\end{document}
`}),s[8]||(s[8]=n("h3",{id:"标准旋转体填充",tabindex:"-1"},"标准旋转体填充",-1)),s[9]||(s[9]=n("p",null,"以后旋转体都严格按照这个模式进行",-1)),i(a,{data:`\\usepackage{tikz-3dplot}
\\begin{document}
...
\\end{tikzpicture}
\\end{document}
`}),s[10]||(s[10]=n("h2",{id:"树状图",tabindex:"-1"},"树状图",-1)),s[11]||(s[11]=n("h3",{id:"纵向",tabindex:"-1"},"纵向",-1)),i(a,{data:`\\begin{document}
\\begin{tikzpicture}
    % 根节点
    \\node {$z$}
        child {node {$x$} 
...
\\end{tikzpicture}
\\end{document}
`}),s[12]||(s[12]=n("h3",{id:"横向",tabindex:"-1"},"横向",-1)),i(a,{data:`\\begin{document}
\\begin{tikzpicture}[
    grow=right, % 让树从左向右生长
...
\\end{tikzpicture}
\\end{document}
`}),s[14]||(s[14]=n("hr",null,null,-1)),s[15]||(s[15]=n("h2",{id:"其他案例",tabindex:"-1"},"其他案例",-1)),s[16]||(s[16]=n("p",null,[t("一个失败的案例, 原因是忘记导入 "),n("code",null,"\\usepackage{tikz-3dplot}"),t(" 包了, 加上就好")],-1)),i(a,{data:`\\usepackage{tikz-3dplot}
\\begin{document}
\\begin{tikzpicture}
    % 设置 3D 视角
    \\tdplotsetmaincoords{70}{120}
...
\\end{tikzpicture}
\\end{document}
`}),s[17]||(s[17]=n("h2",{id:"automaton",tabindex:"-1"},"Automaton",-1)),s[18]||(s[18]=n("h3",{id:"tikz绘制自动机的状态转移图示例",tabindex:"-1"},"tikz绘制自动机的状态转移图示例:",-1)),i(a,{data:`\\usepackage{tikz}
...
\\end{tikzpicture}
\\end{document}
`}),s[19]||(s[19]=n("h3",{id:"多边形",tabindex:"-1"},"多边形",-1)),i(a,{data:`\\usepackage{tikz}
...
`}),s[20]||(s[20]=n("h3",{id:"example",tabindex:"-1"},"example",-1)),i(a,{data:`\\usepackage{tikz}
